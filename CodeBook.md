...
## Identifiers 
The base data are grouped by the mean value and the standard deviation std():
subject - The ID of the test subject
activity - The type of activity performed when the corresponding measurements were taken

## Activity
The 30 subjects are numbered sequentially from 1 to 30. Activity column are divided into 6 types as listed below.
